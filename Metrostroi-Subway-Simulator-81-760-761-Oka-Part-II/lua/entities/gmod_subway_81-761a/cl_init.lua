...
ENT.ButtonMap["PVZ"] = {
    ...
    buttons = {
		{ID = "SF58Toggle",x=0*16+8,y=0,w=16,h=50,tooltip="SF58"},	
		{ID = "SF31Toggle",x=1*16+8,y=0,w=16,h=50,tooltip="SF31"},
		{ID = "SF32Toggle",x=2*16+8,y=0,w=32,h=50,tooltip="SF32"},
		{ID = "SF33Toggle",x=4*16+8,y=0,w=32,h=50,tooltip="SF33"},
		{ID = "SF34Toggle",x=6*16+8,y=0,w=16,h=50,tooltip="SF34"},
		{ID = "SF36Toggle",x=7*16+8,y=0,w=16,h=50,tooltip="SF36"},
		{ID = "SF37Toggle",x=8*16+8,y=0,w=16,h=50,tooltip="SF37"},
		{ID = "SF38Toggle",x=9*16+8,y=0,w=16,h=50,tooltip="SF38"},
		
		{ID = "SF39Toggle",x=0*16+8,y=125,w=16,h=50,tooltip="SF39"},
		{ID = "SF40Toggle",x=1*16+8,y=125,w=16,h=50,tooltip="SF40"},
		{ID = "SF41Toggle",x=2*16+8,y=125,w=16,h=50,tooltip="SF41"},
		{ID = "SF42Toggle",x=3*16+8,y=125,w=16,h=50,tooltip="SF42"},
		{ID = "SF43Toggle",x=4*16+8,y=125,w=16,h=50,tooltip="SF43"},
		{ID = "SF44Toggle",x=5*16+8,y=125,w=16,h=50,tooltip="SF44"},	
		{ID = "SF53Toggle",x=6*16+8,y=125,w=16,h=50,tooltip="SF53"},
		{ID = "SF54Toggle",x=7*16+8,y=125,w=16,h=50,tooltip="SF54"},		
		{ID = "SF56Toggle",x=8*16+8,y=125,w=16,h=50,tooltip="SF56"},	
		{ID = "SF57Toggle",x=9*16+8,y=125,w=16,h=50,tooltip="SF57"},

		{ID = "SF45Toggle",x=0*16+8,y=250,w=16,h=50,tooltip="SF45"},
		{ID = "SF46Toggle",x=1*16+8,y=250,w=16,h=50,tooltip="SF46"},
		{ID = "SF47Toggle",x=2*16+8,y=250,w=16,h=50,tooltip="SF47"},
		{ID = "SF48Toggle",x=3*16+8,y=250,w=16,h=50,tooltip="SF48"},
		{ID = "SF49Toggle",x=4*16+8,y=250,w=16,h=50,tooltip="SF49"},
		{ID = "SF50Toggle",x=5*16+8,y=250,w=16,h=50,tooltip="SF50"},
		{ID = "SF51Toggle",x=6*16+8,y=250,w=16,h=50,tooltip="SF51"},
		{ID = "SF52Toggle",x=7*16+8,y=250,w=16,h=50,tooltip="SF52"},
		{ID = "SF55Toggle",x=8*16+8,y=250,w=16,h=50,tooltip="SF55"},
		{ID = "SF59Toggle",x=9*16+8,y=250,w=16,h=50,tooltip="SF59"},
    }
}
...
ENT.ButtonMap["Power"] = {
    ...
    buttons = {
		{ID = "PowerOnSet",x=17, y=25, radius=20, tooltip = "Бортсеть вкл",model = {
